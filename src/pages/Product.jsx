      ...
      <div className="w-full md:mr-10 h-full gap-2 lg:gap-8 flex items-start justify-center flex-col overflow-hidden px-3 lg:px-0">
        ...
        <div className="w-11/12 flex items-center justify-between lg:flex-row flex-col gap-2">
          ...
          <button
            ...
            className="p-3 flex items-center font-Roboto w-fit justify-center border-solid border-[1px] font-medium tracking-wider cursor-pointer active:scale-[.98] transition duration-200 ease-linear border-black"
          >
            Add to Cart
